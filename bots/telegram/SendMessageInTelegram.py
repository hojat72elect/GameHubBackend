...
"""
Don't pay attention to other files in this directory, this is the correct way to send a message in python."""
...
async def sendMessage() -> asyncio.coroutine:
    ...
    # All the recipients
    await client.send_message('hojat72elect', "don't tickle a sleeping dragon!")
